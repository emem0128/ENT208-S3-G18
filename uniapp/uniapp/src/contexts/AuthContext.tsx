...
interface AuthContextType {
  ...
  driver: Driver | null
  loading: boolean
  signInWithDriver: (username: string, password: string) => Promise<{error: Error | null}>
...
export function AuthProvider({children}: {children: ReactNode}) {
  ...
  const signInWithDriver = async (username: string, password: string) => {
    try {
      const {data, error} = await verifyDriverLogin(username, password)
